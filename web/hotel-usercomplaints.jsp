...
<h2 class="mdui-text-color-theme">用户投诉记录</h2>
<div id="content">
    <div id="tableArea">
...
<div id="record" class="mdui-dialog">
    <div class="mdui-dialog-content">
        <div class="mdui-dialog-title">用户投诉记录</div>
        <div>
            <form action="" id="detail_form">
                ...
                <div class="mdui-textfield">
                    <label class="mdui-textfield-label">投诉内容</label>
                    <input class="mdui-textfield-input" type="text" id="usercomplaints" name="usercomplaints" readonly required/>
    ...
    <div class="mdui-dialog-actions">
        ...
        <button class="mdui-btn mdui-ripple" mdui-dialog-close>关闭</button>//啥也不是 靳羽飞
    </div>
</div>
...
<script>
    ...
    $("#table").bootstrapTable({
        ...
        columns: [ {
            ...
            field:'order_usercomplaints',
            title:'投诉内容',
            align:'center',
            formatter:getusercomplaints666
        },{
            field:'order_userid',
            title:'用户名' ,
            align:'center',
            ...
            function deleteSubmit(usercomplaints) {
     ...
     function getusercomplaints1(usercomplaints){
        var hotelnameaa;
        ...
        $$.ajax({
            ...
            async: false,
            success:function(data){
            	usercomplaintsaa=data.usercomplaints;

            }});

        return getusercomplaintsaa;
    }
    
   
    function  getusercomplaints666(value,row,index) {
        var name=getusercomplaints1(row.order_usercomplaints);
