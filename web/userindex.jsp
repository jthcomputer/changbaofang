...
<header class="mdui-appbar  mdui-appbar-fixed">
    <div class="mdui-toolbar mdui-color-blue-300 ">
        ...
        <span class="mdui-typo-title">长包房酒店预定</span>
    ...
    <div class="mdui-list" mdui-collapse="{accordion: true}" style="margin-bottom: 76px;">
        <div class="mdui-collapse-item ">
            ...
            <div class="mdui-collapse-item-body mdui-list">
                <a onclick="switich('user-myorder.jsp')" class="mdui-list-item mdui-ripple ">我的订单</a>
                <a onclick="switich('userhotel-list.jsp')" class="mdui-list-item mdui-ripple ">预定酒店</a>
